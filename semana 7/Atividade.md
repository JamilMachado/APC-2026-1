Neste arquivo foram copiados os exercicios com os procedimentos realizados no https://pythontutor.com/visualize.html#mode=edit
...
8. Strings
cchar s[] = "hello";      // 6 bytes: h e l l o \0
...
12. Enums
ctypedef enum { DOM=0, SEG, TER, QUA, QUI, SEX, SAB } DiaSemana;
...
15. Escopo e duração
ClasseDeclaraçãoDuraçãoEscopoautomáticadentro da funçãoblocolocalstatic localdentro da funçãotodo programalocalstatic globalfora de funçõestodo programaarquivo .cexternfora / referênciatodo programamúltiplos .c
